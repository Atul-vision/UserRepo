...
public class MyConfig {
	...
	public OAuth2AuthorizedClientManager manager(ClientRegistrationRepository clientRegistrationRepository,
	    ...
	    DefaultOAuth2AuthorizedClientManager manager2 = new DefaultOAuth2AuthorizedClientManager(clientRegistrationRepository, oAuth2AuthorizedClientRepository);
	    manager2.setAuthorizedClientProvider(provider);
	    return manager2;
	 }
